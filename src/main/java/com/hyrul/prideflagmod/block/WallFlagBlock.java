...
public class WallFlagBlock extends Block implements Waterloggable {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> VoxelShapes.cuboid(0, 0, 15 / 16f, 1, 1, 1);
            case SOUTH -> VoxelShapes.cuboid(0, 0, 0, 1, 1, 1 / 16f);
            case WEST -> VoxelShapes.cuboid(15 / 16f, 0, 0, 1, 1, 1);
            case EAST -> VoxelShapes.cuboid(0, 0, 0, 1 / 16f, 1, 1);
